        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
          {cases.length === 0 ? (
            ...
            <div key={c.id} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg p-4 flex flex-col gap-2.5">
              ...
              {c.photo_url && <img src={getThumbnailUrl(c.photo_url) || c.photo_url} alt={`Case ${c.id}`} className="w-full h-36 object-cover rounded-lg border border-slate-200 dark:border-slate-700" loading="lazy" />}
