  ...
  return (
    <div className="flex flex-col gap-6 max-w-3xl w-full mx-auto">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="font-bold text-xl text-slate-900 dark:text-white">Until help arrives</h1>
          <p className="text-xs text-slate-500 dark:text-slate-400">Calm, practical steps for the first 10 minutes</p>
        </div>
      </div>

      <div className="bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-800 rounded-lg p-3.5 text-amber-900 dark:text-amber-300 text-sm flex items-start gap-2">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg p-4 flex flex-col gap-2">
        ...
        <select
          ...
          className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg px-3 py-2.5 text-sm text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500"
        >
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="bg-slate-100 dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700 rounded-lg p-4 text-sm text-slate-700 dark:text-slate-300">
            ...
            <Link to="/report" className="ml-1 text-teal-700 dark:text-teal-400 font-medium hover:underline">Open report form</Link>
          </div>
        </>
      ) : null}
    </div>
